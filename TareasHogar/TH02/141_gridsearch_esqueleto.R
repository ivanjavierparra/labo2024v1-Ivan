...
setwd("c:\\Users\\Usuario\\Documents\\Universidad\\austral\\2024\lab1\\TareasHogar\\Tarea-02\\gridSearchIvan-04-CPchicos\\") # Establezco el Working Directory
# cargo los datos
...
archivo_salida <- "c:\\Users\\Usuario\\Documents\\Universidad\\austral\\2024\lab1\\TareasHogar\\Tarea-02\\gridSearchIvan-04-CPchicos\\gridsearch.txt"
# c:\Users\Usuario\Documents\Universidad\austral\2024\lab1\TareasHogar\Tarea-02\gridSearchIvan-04-CPchicos\
...
for ( vcp in c(-0.9) )
{
  for (vmax_depth in c(5,6,7,8,9,10)) {
    for (vmin_split in c(600,700,800,900,1000))
    {
      vmin_bucket_min <- 25
