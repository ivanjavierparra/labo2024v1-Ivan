...
setwd("~/buckets/b1/")
# setwd("c:\\Users\\Usuario\\Documents\\Universidad\\austral\\2024\\lab1\\TareasHogar\\Tarea-03\\11 - Script Optimizacion Bayesiana\\")
...
dir.create("./exp/HT3330v3/", showWarnings = FALSE)
