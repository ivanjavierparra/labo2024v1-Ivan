...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_child_samples", lower = 10L, upper = 500L),
  # makeIntegerParam("num_boost_round", lower = 100L, upper = 1000L),
  makeIntegerParam("bagging_freq", lower = 1L, upper = 10L),
  # makeIntegerParam("max_depth", lower = 4L, upper = 15L),
  # makeIntegerParam("max_bin", lower = 10L, upper = 100L),
  makeNumericParam("reg_alpha", lower = 0.0, upper = 2.0),
  makeNumericParam("reg_lambda", lower = 0.0, upper = 2.0),
  makeNumericParam("subsample", lower = 0.01, upper = 1.0),
  makeIntegerParam("subsample_freq", lower = 1L, upper = 10L),
  # makeNumericParam("lambda_l1", lower = 1, upper = 10),
  # makeNumericParam("lambda_l2", lower = 1, upper = 10),
  # makeDiscreteParam("boosting", values = c("gbdt", "rf", "dart", "goss")),
